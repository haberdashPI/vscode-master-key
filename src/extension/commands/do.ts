...
// import { WhenNoBindingHeader, Command } from '../../rust/parsing/lib/parsing';
...
//     // TODO: revise this function to use new rust data format
...
//                         const whenNoBinding = (bindings.mode(mode))?.whenNoBinding();
//                         if (whenNoBinding == WhenNoBindingHeader.Insert) {
